    ...
    <>
      <section className="bg-gray-900 w-screen text-white mt-10 mb-0 min-h-screen">
        ...
        <div>
          ...
          <p className="text-[clamp(1rem,1.5vw,4rem)] place-self-center text-wrap w-2/3 pt-[clamp(4vh,8vh,10vh)]">
          ...
          <div className="place-items-center justify-items-center *:*:place-self-center caraousel sm:max-2xl:w-full snap-x snap-mandatory overflow-hidden grid grid-flow-col-dense grid-cols-auto grid-rows-1 place-content-evenly gap-[clamp(20vh,25vh,30vh)] md:grid-flow-row-dense md:grid-cols-3 md:grid-rows-3 *:*:text-[clamp(2rem,2vw,4rem)] w-full *:w-screen mb-[clamp(4vh,8vh,10vh)] pt-[clamp(6vh,15vh,20vh)] pb-[clamp(3vh,8vh,10vh)]">
          ...
          <div className="place-items-center justify-items-center *:*:place-self-center carousel snap-x snap-mandatory overflow-hidden grid grid-flow-col-dense grid-cols-auto grid-rows-1 gap-x-1 *:text-[clamp(2rem,2vw,4rem)] *:w-screen h-[clamp(500px,100vh,800px)] pt-[clamp(5vh,25vh,50vh)]">
            <div id="fooddemo1" className="relative carousel-item">
              <div className="flex items-center justify-center">
                <img src="images/FoodHaven/FoodHaven_home_page.png" className="absolute bottom-1/1 w-auto h-[clamp(500px,100%,800px)]"></img>
            ...
            <div id="fooddemo3" className="relative carousel-item">
              <div className="flex items-center justify-center">
            ...
            <div id="fooddemo4" className="relative carousel-item">
              <div className="flex items-center justify-center">
        ...
        <div>
          ...
          <div className="place-items-center justify-items-center *:*:place-self-center caraousel sm:max-2xl:w-full snap-x snap-mandatory overflow-hidden grid grid-flow-col-dense grid-cols-auto grid-rows-1 place-content-evenly gap-[clamp(20vh,25vh,30vh)] md:grid-flow-row-dense md:grid-cols-3 md:grid-rows-3 *:*:text-[clamp(2rem,2vw,4rem)] w-full *:w-screen mb-[clamp(4vh,8vh,10vh)] pt-[clamp(6vh,30vh,50vh)] pb-[clamp(6vh,10vh,15vh)]">
          ...
          <div className="place-items-center justify-items-center *:*:place-self-center sm:max-2xl:w-full snap-x snap-mandatory overflow-hidden grid grid-flow-col-dense grid-cols-2 grid-rows-1 gap-[clamp(1vh,2vh,3vh)] *:*:text-[clamp(2rem,2vw,4rem)] w-full *:w-screen pt-[clamp(6vh,30vh,50vh)] pb-[clamp(6vh,30vh,50vh)]">
