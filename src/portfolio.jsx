    ...
    <>
      <section className="bg-gray-900 text-white mt-10 mb-0 min-h-screen">
        ...
        <div>
          ...
          <div className="grid grid-flow-row-dense grid-cols-4 grid-rows-2 gap-x-1 gap-y-40 justify-items-center *:text-4xl *:transition *:delay-100 *:duration-300 *:ease-in-out *:hover:-translate-y-1 *:hover:scale-110 *:w-65 *:h-25 *:mt-8">
            ...
            <div className="relative bg-[url(/images/Ruby_On_Rails_Logo.svg.png)] bg-cover bg-center text-center">
              <div className="absolute bottom-0 top-35 left-0 right-0 text-center flex items-center justify-center">Ruby on Rails</div>
            </div>
            <div className="relative bg-[url(/images/sinatra_logo.png)] bg-contain bg-no-repeat bg-center text-center">
              <div className="absolute bottom-0 top-35 left-0 right-0 text-center flex items-center justify-center">Sinatra</div>
            </div>
            ...
            <div className="relative bg-[url(/images/google_maps_logo.png)] bg-contain bg-no-repeat bg-center text-center">
              <div className="absolute bottom-0 top-35 left-0 right-0 text-center flex items-center justify-center">Google Maps Platform</div>
            </div>
            <div className="relative bg-[url(/images/bootstrap-logo.svg)] bg-contain bg-no-repeat bg-center text-center">
              <div className="absolute bottom-0 top-35 left-0 right-0 text-center flex items-center justify-center">Bootstrap</div>
            </div>
            <div className="relative bg-[url()] bg-cover bg-center text-center">
              <div className="absolute bottom-0 top-35 left-0 right-0 text-center flex items-center justify-center">AWS - Elastic Beanstalk</div>
            </div>
            <div className="relative bg-[url()] bg-cover bg-center text-center">
              <div className="absolute bottom-0 top-35 left-0 right-0 text-center flex items-center justify-center">AWS - EC2</div>
            </div>
            <div className="relative bg-[url()] bg-cover bg-center text-center">
              <div className="absolute bottom-0 top-35 left-0 right-0 text-center flex items-center justify-center">AWS - RDS</div>
            </div>
          </div>
          <div className="w-150 text-5xl font-extrabold text-center justify-center place-self-center pl-8 mt-40 mb-10">Scroll To See how the App Works</div>
          <div className="w-340 h-260 justify-start place-self-center snap-x overflow-x-auto grid grid-flow-col-dense mb-12 *:snap-center *:text-2xl *:w-340 *:h-220 *:mt-2 *:mb-12">
            <div className="relative bg-[url(/images/FoodHaven/FoodHaven_home_page.png)] bg-contain bg-no-repeat bg-center text-center">
            ...
            <div className="relative bg-[url(/images/FoodHaven/FoodHaven_Market_search.png)] bg-contain bg-no-repeat bg-center text-center">
            ...
            <div className="relative bg-[url(/images/FoodHaven/FoodHaven_Market_search_results.png)] bg-contain bg-no-repeat bg-center text-center">
              <div className="absolute bottom-0 120 left-0 right-0 text-center flex items-center justify-center mt-77">Search results</div>
              <div className="absolute bottom-75 left-300 right-0 text-center items-center justify-center text-green-500 bg-transparent text-4xl bg-transparent font-extrabold mb-35 text-center flex items-center justify-center animate-pulse">
                →
              </div>
            </div>
            <div className="relative bg-[url(/images/FoodHaven/FoodHaven_Directions.png)] bg-contain bg-no-repeat bg-center text-center">
        ...
        <div>
          <div className="w-150 text-5xl font-extrabold pl-8 mt-45 mb-10">Lego Inventory Manager</div>
          <div className="flex flex-wrap space-x-10 justify-start *:text-2xl pl-15">
          ...
          <div className="grid grid-flow-row-dense grid-cols-4 grid-rows-1 gap-x-1 justify-items-center h-65 *:text-4xl *:transition *:delay-100 *:duration-300 *:ease-in-out *:hover:-translate-y-1 *:hover:scale-110 *:w-65 *:h-25 *:mt-8">
